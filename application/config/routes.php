...
$route['quy-trinh-gao-sach'] = 'home/quytrinh';
$route['dat-hang-thanh-cong'] = "home/muahang"; 
...
$route['admincp/user/(:num)'] = "admin/users/list_user/$1";
$route['admincp/profile/(:num)'] = "admin/users/profile/$1";
//--------------------Media
...
$route['admincp/content/(:any)'] = "news/index/$1";
...
//------------------HOME
$route['danh-sach'] = "home/list_app";
$route['dang-ky'] = "admincp/register";
$route['goi-dich-vu'] = "home/pakage";
...
$route['danhmuc-(:any)'] = "blog/category/$1";
//$route['panel/deposit/:num/(:any)'] = "panel/deposit/$1/$2";
